...
function PageFooter() {
  return (
    <p className="text-center text-[11px] uppercase tracking-wider2 py-16" style={{ color: C.stone }}>
      Casa Banega — El lujo sin esfuerzo
    </p>
  );
}
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="hidden md:block absolute left-6 top-0 bottom-0 items-center" style={{ writingMode: "vertical-rl" }}>
          <span className="text-[10px] tracking-wider3 uppercase flex h-full items-center" style={{ color: C.stone }}>
            Quiet luxury — el lujo sin esfuerzo
          </span>
        </div>
          ...
          <div className="md:col-span-7 md:col-start-6">
            <Reveal delay={100}>
              ...
              <p className="mt-8 text-base md:text-lg leading-loose max-w-xl" style={{ color: "#57524A" }}>
                Vivimos rodeados de un lujo que necesita ser visto para existir. Casa Banega cree en lo
                opuesto — el silencio bien puesto, el detalle que no necesita explicarse, las casas y las
                personas que entendieron que la elegancia es, sobre todo, una forma de esfuerzo invisible.
                Escribimos sobre hoteles, oficios y rituales que eligieron no gritar.
              </p>
            </Reveal>
          </div>
        </div>
